...
//    private int totalMovedLength;
    public NumberProgressBar(Context context, AttributeSet attrs) {
        ...
        // 构造器中初始化数据
        //小圆半径
        smallR = dip2px(context, 4);
        //大圆半径
        bigR = dip2px(context, 8);
        //进度条高度
        radius = dip2px(context, 10) / 2;
    ...
    private void initData() {
        ...
        // 已完成进度条画笔的属性
        paintInit.setColor(context.getResources().getColor(R.color.colorAccent));
        ...
        // 大圆画笔
        paintEndBig.setColor(context.getResources().getColor(R.color.colorAccent));
        ...
        // 百分比文字画笔的属性
        //设置百分比文字的尺寸
        int paintTextSizePx = sp2px(context, 11);
        paintText.setColor(context.getResources().getColor(R.color.colorAccent));
