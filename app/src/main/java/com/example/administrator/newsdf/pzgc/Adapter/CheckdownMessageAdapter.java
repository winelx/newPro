...
public class CheckdownMessageAdapter extends RecyclerView.Adapter<CheckdownMessageAdapter.MyViewHolder> implements LeftSlideView.IonSlidingButtonListener {
    ...
    public CheckdownMessageAdapter(Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        //最后一条消息
        holder.home_item_content.setVisibility(View.GONE);
        //最后一条消息时间
        holder.home_item_time.setVisibility(View.GONE);
        //消息数量
