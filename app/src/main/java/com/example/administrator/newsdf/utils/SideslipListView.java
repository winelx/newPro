...
public class SideslipListView extends ListView {
    ...
    private RelativeLayout.LayoutParams mItemLayoutParams;//手指按下时所在的item的布局参数
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mPointPosition != -1) {
                    ...
                    mItemLayoutParams = (RelativeLayout.LayoutParams) mPointChild.getChildAt(0).getLayoutParams();
