 ...
 * @description:特种设备详情界面验证
 * @Activity：
 */

public class DetailsProving {
    /**
     * business :
    ...
    public DetailsProving(String business, String operTime, String realname, String times, int type, String view) {
