 ...
 * @description:整改通知单详情主体实体类
 * @Activity：
 */

public class DeviceDetailsBean {
        /**
         * checkDate : 2018-12-12
         * checkOrgName : 路桥公司本部
         * checkUserName : 刘波
         * enumber : bh052
         * id : fb8420e119094b2c85d5ccb0e863577b
         * number : TZSBXJ-20181212-2
         * orgId : 539d8c12c94943449dca5d87c1d8e8e5
         * orgName : 重遵六标
         * personLiable : dbe9d3e4d6ec496c819416c761e5f9e2
         * personLiableName : 柴广
         * place : 地点使用
         * remarks :
         * serviceStatus : 23
