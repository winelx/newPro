...
public class SCheckTasklistBean {
    String checkOrgName;
    String checkUser;
    String createDate;
    String id;
...
//                "wbsMainName": "K77+046～K77+287.455"
    ...
    public SCheckTasklistBean(String checkOrgName, String checkUser, String createDate, String id, String orgName, String status, int iwork, String wbsMainName) {
