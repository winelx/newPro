...
import com.example.administrator.yanghu.pzgc.adapter.CheckListAdapter;
import com.example.administrator.yanghu.pzgc.bean.Home_item;
import com.example.administrator.yanghu.pzgc.special.programme.activity.ProgrammeListActivity;
 ...
 * @说明 全部组织
 **/
public class ProAllOrgFragment extends LazyloadFragment {
    ...
    public void getdata() {
        OkGo.get(Api.ORGINFOBYCNFBYPROJECT)
                .params("isAll", true)
