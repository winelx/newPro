package com.example.administrator.yanghu.pzgc.fragment.homepage;
...
import com.example.administrator.yanghu.pzgc.adapter.AllTaskListItem;
import com.example.administrator.yanghu.pzgc.adapter.TaskPhotoAdapter;
import com.example.administrator.yanghu.pzgc.activity.home.utils.HomeUtils;
...
import com.example.administrator.yanghu.pzgc.bean.Inface_all_item;
import com.example.administrator.yanghu.pzgc.bean.OrganizationEntity;
import com.example.administrator.yanghu.pzgc.bean.PhotoBean;
import com.example.administrator.yanghu.pzgc.callback.TaskCallback;
...
import com.example.administrator.yanghu.treeView.Node;
import com.example.administrator.yanghu.treeView.TaskTreeListViewAdapter;
import com.example.administrator.yanghu.treeView.TreeListViewAdapter;
 ...
 * version:
 */
public class CommentmessageActivity extends BaseActivity implements View.OnClickListener, TaskCallback {
    ...
    private void initData() {
        ...
        circle.setVisibility(View.GONE);
        //图册适配器
        taskAdapter = new TaskPhotoAdapter(imagePaths, CommentmessageActivity.this);
        //图册listview
