...
import com.example.administrator.yanghu.pzgc.activity.work.BrightspotFragment;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LoveDao.queryLove().size() == 0) {
            ...
            String path = "/storage/emulated/0/Android/data/com.example.administrator.yanghu/tiny";
            delFolder(path);
        }
        //新本版检测
        uplogding();
