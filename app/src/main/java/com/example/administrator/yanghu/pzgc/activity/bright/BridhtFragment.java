package com.example.administrator.yanghu.pzgc.activity.bright;
...
import com.example.administrator.yanghu.pzgc.adapter.BridhtAdapter;
import com.example.administrator.yanghu.pzgc.activity.MainActivity;
import com.example.administrator.yanghu.pzgc.bean.BrightBean;
import com.example.administrator.yanghu.pzgc.callback.BrightCallBack;
import com.example.administrator.yanghu.pzgc.callback.BrightCallBackUtils;
...
import static com.example.administrator.yanghu.pzgc.utils.Dates.stampToDate;
 ...
 *         version:
 */
public class BridhtFragment extends Fragment implements BrightCallBack {
    View view;
                        ...
                        try {
                            ...
                            if (jsonArray.length() > 0) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    mData.add(new BrightBean(id, orgId, orgName, taskName, leadername, leaderImg, updateDate, TaskId, 0, ImagePaths));
                                }
                            } else {
                                if (stauts) {
