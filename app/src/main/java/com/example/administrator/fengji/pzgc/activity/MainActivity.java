...
import com.example.administrator.fengji.pzgc.activity.work.BrightspotFragment;
import com.example.administrator.fengji.pzgc.bean.Tab;
import com.example.administrator.fengji.pzgc.callback.JPushCallUtils;
import com.example.administrator.fengji.pzgc.fragment.HomeFragment;
import com.example.administrator.fengji.pzgc.fragment.IndexFrament;
import com.example.administrator.fengji.pzgc.fragment.MineFragment;
import com.example.administrator.fengji.pzgc.fragment.WorkFragment;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LoveDao.queryLove().size() == 0) {
            ...
            String path = "/storage/emulated/0/Android/data/com.example.administrator.fengji/tiny";
            delFolder(path);
        }
        //新本版检测
        uplogding();
