package com.example.administrator.fengji.pzgc.fragment;
...
import com.example.administrator.fengji.pzgc.activity.chagedreply.ChagedreplyActivity;
import com.example.administrator.fengji.pzgc.activity.check.activity.CheckRectificationWebActivity;
import com.example.administrator.fengji.pzgc.activity.check.activity.CheckTaskWebActivity;
import com.example.administrator.fengji.pzgc.activity.check.activity.CheckdownMessageActivity;
import com.example.administrator.fengji.pzgc.activity.check.activity.CheckmanagementActivity;
import com.example.administrator.fengji.pzgc.activity.check.activity.CheckstandardListActivity;
import com.example.administrator.fengji.pzgc.activity.check.activity.newcheck.activity.ExternalCheckActiviy;
import com.example.administrator.fengji.pzgc.activity.check.activity.record.activity.SuperviseCheckRecordActivity;
import com.example.administrator.fengji.pzgc.activity.device.DeviceActivity;
import com.example.administrator.fengji.pzgc.activity.home.OrgrankingActivity;
import com.example.administrator.fengji.pzgc.activity.pchoose.activity.PchooseActivity;
import com.example.administrator.fengji.pzgc.activity.work.NotuploadActivity;
import com.example.administrator.fengji.pzgc.activity.work.OrganiwbsActivity;
import com.example.administrator.fengji.pzgc.activity.work.PushCheckActivity;
import com.example.administrator.fengji.pzgc.special.loedger.activity.LoedgerActivity;
import com.example.administrator.fengji.pzgc.special.programme.activity.ProgrammeActivity;
