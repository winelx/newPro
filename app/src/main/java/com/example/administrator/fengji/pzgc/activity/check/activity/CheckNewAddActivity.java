...
import com.example.administrator.fengji.pzgc.callback.CheckNewCallback;
import com.example.administrator.fengji.pzgc.callback.CheckNewCallbackUtils;
import com.example.administrator.fengji.pzgc.callback.CheckTaskCallbackUtils;
...
import static com.example.administrator.fengji.R.id.check_new_buttons;
...
public class CheckNewAddActivity extends BaseActivity implements View.OnClickListener, CheckNewCallback {
    ...
    private String success = null, sysMsgNoticeId;
    ...
    public void getdata() {
        ...
        PostRequest request = post(Requests.CHECKGET_BY_ID);
        request.params("Id", taskId);
        request.params("sysMsgNoticeId", sysMsgNoticeId);
