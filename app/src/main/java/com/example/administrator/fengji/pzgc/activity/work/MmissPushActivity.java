...
import com.example.administrator.fengji.pzgc.activity.pchoose.activity.StandardActivity;
...
import com.example.administrator.fengji.pzgc.utils.TreeUtlis;
import com.example.administrator.fengji.treeView.Node;
import com.example.administrator.fengji.treeView.PushListviewAdapter;
...
public class MmissPushActivity extends BaseActivity {
    ...
    private void initEvent() {
        mTreeAdapter.setOnTreeNodeClickListener(new TreeListViewAdapter.OnTreeNodeClickListener() {
            @Override
            public void onClick(com.example.administrator.fengji.treeView.Node node, int position) {
                if (node.isLeaf()) {
                } else {
                    //判断是否为空
