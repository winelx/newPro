...
public class LeftSlideView extends HorizontalScrollView {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed) {
            ...
            mScrollWidth = mTextView_Delete.getWidth()+mTextView_Set.getWidth()+50;
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE://移动
                mIonSlidingButtonListener.onDownOrMove(LeftSlideView.this);
                break;
    ...
    public interface IonSlidingButtonListener {
        ...
        //该方法在Adapter中实现
        void onMenuIsOpen(LeftSlideView view);//判断菜单是否打开
