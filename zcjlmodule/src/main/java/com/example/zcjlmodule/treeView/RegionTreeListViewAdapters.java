 ...
 * version:
*/
public class RegionTreeListViewAdapters<T> extends TreeListViewAdapters<T> {
    public RegionTreeListViewAdapters(ListView tree, Context context,
    ...
    public View getConvertView(final Nodes node, final int position, View convertView,
        ...
        final RegionZcActivity mian = (RegionZcActivity) mContext;
        if (convertView == null) {
        ...
        holder.mText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final RegionZcActivity activity = (RegionZcActivity) mContext;
