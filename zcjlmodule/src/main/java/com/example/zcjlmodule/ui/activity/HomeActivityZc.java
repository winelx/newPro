...
import measure.jjxx.com.baselibrary.frame.BaseActivity;

public class HomeActivityZc extends BaseActivity {
    ...
    public void initTab() {
        ...
        BaseTab tab_mine = new BaseTab(MineFragmentZc.class, R.string.work, R.drawable.tab_mine_style_zc, 0);
        mTabs.add(tab_home);
        mTabs.add(tab_work);
        mTabs.add(tab_mine);
        mTabHost = (FragmentTabHost) findViewById(R.id.mFragmentTabHost);
