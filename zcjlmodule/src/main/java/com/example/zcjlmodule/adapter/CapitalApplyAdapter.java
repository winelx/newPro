...
public class CapitalApplyAdapter extends BaseQuickAdapter<CapitalBean, BaseViewHolder> {

    public CapitalApplyAdapter(int layoutResId, @Nullable List<CapitalBean> data) {
    ...
    protected void convert(BaseViewHolder helper, CapitalBean item) {
        ...
        //创建时间
        helper.setText(R.id.adapter_capital_data, item.getCreateDate().substring(0,10));
